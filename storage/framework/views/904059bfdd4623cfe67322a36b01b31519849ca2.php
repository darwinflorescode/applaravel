...
<?php $__env->startSection('contenidocentralsuperior'); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $temaactivo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="cursoview">
            <h2>Detalles del Atículo</h2>
            <div class="fb-post1">
                <div class="fb-post1-container">
                    <div class="fb-post1-header">
                        <ul>
                            <li class="active"><a href="<?php echo e(route('web.buscartemas', encrypt($row->link_topics->id))); ?>"
                            ...
                            <ul>
                                <li>
                                    <h3>Categoría: <?php echo e($row->link_topics->category_topics->title); ?> <span> .
                                            <?php echo e($row->link_topics->updated_at->diffForHumans()); ?></span></h3>
                                </li>
                                <li><span>
                                        <?php echo e($row->link_topics->updated_at->formatLocalized('%A %d %B %Y')); ?></span>
                                </li>
                            </ul>
                            <p>
...
<?php echo $__env->make('webapp.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\api\Laravel\darwinflocode\resources\views/web/buscartema.blade.php ENDPATH**/ ?>