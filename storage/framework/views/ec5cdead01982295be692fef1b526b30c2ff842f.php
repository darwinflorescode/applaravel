                     ...
                     <div class="row p-3 my-2 bg-info bg-opacity-10 border border-info rounded-end">
                         ...
                         <div class="col-md-6">
                             ...
                             <select class="form-select" name="id_user" id="id_user">
                                 ...
                                 <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option selected value="<?php echo e($datos->id); ?>"><?php echo e($datos->name); ?></option>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 ...
 <div class="modal fade" id="editformenlace" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static"
     ...
     <div class="modal-dialog modal-dialog-centered modal-xl">
         <div class="modal-content">
             ...
             <form action="<?php echo e(route('enlacess.store')); ?>" method="POST" id="edit_form_register_enlaces" enctype="multipart/form-data"
                 autocomplete="off">
                 <?php echo csrf_field(); ?>
 ...
 <?php /**PATH C:\xampp\htdocs\api\Laravel\laravelproyectweb\resources\views/course/modales.blade.php ENDPATH**/ ?>