<script>
    ...
    $(function() {
        ...
        function fetchAllCategory() {
            $.ajax({
                url: "<?php echo e(route('fetchAlltopic')); ?>",
                method: 'get',
        ...
        $(document).on('click', '.viewIcon', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('load.contenttopic')); ?>",
                method: 'get',
                data: {
                    id: id,
        ...
        $("#add_category_form").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('storetopic')); ?>",
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteIcon', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(route('deletetopic')); ?>",
                        method: 'delete',
                        data: {
                            id: id,
                            _token: csrf
        ...
        $("#edit_category_form").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('topic.update')); ?>",
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
...
<?php /**PATH C:\xampp\htdocs\api\Laravel\laravelproyectweb\resources\views/categorytopic/script.blade.php ENDPATH**/ ?>