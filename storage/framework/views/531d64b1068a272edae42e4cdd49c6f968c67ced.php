<script>
    ...
    $(function() {
        ...
        function fetchAllCourse() {
            $.ajax({
                url: "<?php echo e(route('course.fetchAll')); ?>",
                method: 'get',
                success: function(response) {
                    $("#show_all_courses").html(response);
                    $("table").DataTable({
                        order: [0, 'desc']
                    });
                }
        ...
        $(document).on('click', '.viewIcon', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('load.content.course')); ?>",
                method: 'get',
                data: {
                    id: id,
        ...
        $("#add_form_register").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('course.store')); ?>",
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
                ...
                success: function(response) {
                    ...
                    if (response.alerta == "danger") {
                        ...
                        let id_user = document.querySelector(".errors-id_user");
                        id_user.textContent = response.id_user[0];
        ...
        $(document).on('click', '.editIcon', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#id_categoryedit").val(response.category_id);
                    $("#id_useredit").val(response.user_id);
                    $("#fotoeditview").html(
        ...
        $("#edit_form_register").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('course.update')); ?>",
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
                ...
                success: function(response) {
                    ...
                    $("#edit_form_btn").text('Update Course');
                    $("#fotoedit").val(null);
        ...
        function fetchAllEnlaces(_id) {
            ...
            /* alert(id); */
            $.ajax({
                url: "<?php echo e(route('cargar.enlacess')); ?>",
                method: 'get',
                data: {
                    id: id,
                    _token: csrf
        ...
        function loadDatos(_id) {
            ...
            fetchAllEnlaces(id);
            $.ajax({
                url: "<?php echo e(route('load.content.enlacess')); ?>",
                method: 'get',
                data: {
                    id: id,
                    _token: '<?php echo e(csrf_token()); ?>'
                ...
                success: function(response) {
                    ...
                    $("#id_course_topic_").val(response.course_id);
        ...
        $("#edit_form_register_enlaces").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('enlacess.store')); ?>",
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
...
<?php /**PATH C:\xampp\htdocs\api\Laravel\laravelproyectweb\resources\views/course/script.blade.php ENDPATH**/ ?>