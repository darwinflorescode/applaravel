...
<?php $__env->startSection('contenidocentralsuperior'); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="single-stories">
            ...
            <div>
                <a href="#" title="<?php echo e($row->link_topics->title); ?>"> <img
                        src="<?php echo e(Storage::url('public/images/') . $row->link_topics->image); ?>"
...
<?php echo $__env->make('webapp.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\api\Laravel\darwinflocode\resources\views/web/home.blade.php ENDPATH**/ ?>